...
from src.models.Tbot import Tbot
...
# Model args
parser.add_argument('--n_hierarchy', type=int, default=3, help='number of hierarchy')
parser.add_argument('--n_layers', type=int, default=3, help='number of Transformer layers')
parser.add_argument('--n_heads', type=int, default=16, help='number of Transformer heads')
parser.add_argument('--d_model', type=int, default=128, help='Transformer d_model')
parser.add_argument('--d_k', type=int, default=128, help='d_k')
parser.add_argument('--d_v', type=int, default=128, help='d_v') 
...
print('args:', args)
args.save_path = 'saved_models/' + args.dset_finetune + '/masked_tbot/' + args.model_type + '/'
...
if args.is_finetune: args.save_finetuned_model = args.dset_finetune+'_tbot_finetuned'+suffix_name
elif args.is_linear_probe: args.save_finetuned_model = args.dset_finetune+'_tbot_linear-probe'+suffix_name
else: args.save_finetuned_model = args.dset_finetune+'_tbot_finetuned'+suffix_name
...
def get_model(c_in, args, head_type, weight_path=None):
    ...
    model = Tbot(
        n_vars = c_in,
        num_patch = num_patch,
        forecast_len = args.target_points,
...
if __name__ == '__main__':
    ...
    if args.is_finetune:
        ...
        args.dset = args.dset_finetune
        weight_path = args.save_path+args.dset_finetune+'_tbot_finetuned'+suffix_name
        # Test
